  ...
  return (
    <div className="space-y-8 rounded-2xl border border-slate-100 bg-white p-6 dark:border-slate-800/80 dark:bg-slate-950">
      <div className="flex items-center justify-between">
        <h2 className="text-md font-bold text-ink dark:text-white">Bộ lọc tìm kiếm</h2>
        {hasActiveFilters && (
          <button
      ...
      {/* Brand Filter */}
      <div>
        <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Thương hiệu</h3>
      ...
      {/* Category Filter */}
      <div>
        <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Phân khúc</h3>
